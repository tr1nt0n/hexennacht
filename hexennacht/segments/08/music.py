...
hexennacht.drumming(
    ...
    durations=[(2, 1), (1, 4), (1, 2), (1, 4), (1, 2), (1, 4), (1, 4), (3, 4), (1, 4), (1, 4), (3, 4), (1, 4), (1, 4), (1, 4), (1, 4), (5, 4),],
    pitched=False
)
...
for voice in ["violin 2 voice", "viola voice", "cello voice"]:
    trinton.append_rests(
        score=score,
        voice=voice,
        rests=[abjad.Rest("r1"), abjad.Rest("r1")]
    )

    hexennacht.drumming(
        score=score,
        voice=voice,
        durations=[(1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4),],
        pitched=True
    )
...
trinton.append_rests(
    ...
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r2"), abjad.Rest("r8"),]
)
...
hexennacht.violin_solo(
    ...
    voice="violin 1 voice",
    tuplet_index=4,
    durations=[(3, 8), (1, 2), (1, 4), (1, 4), (3, 4), (1, 4), (1, 4), (1, 4), (1, 4), (1, 4), (5, 4)],
    pitched=True,
    pitch_index=9
)
...
trinton.append_rests(
    score=score,
    voice="piano 1 voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r2."), abjad.Rest("r2")]
)
...
trinton.handwrite(
    score=score,
    voice="piano 2 voice",
    durations=[(3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (3, 16), (1, 16)],
    pitch_list=[[-35, -36, -37, -38, -39]]
)
...
trinton.append_rests(
    score=score,
    voice="harp voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r8")]
)
...
trinton.append_rests(
    score=score,
    voice="marimba voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r4")]
)
...
trinton.append_rests(
    score=score,
    voice="flute voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r4")]
)

trinton.handwrite(
    score=score,
    voice="flute voice",
    durations=[(1, 4), (1, 16), (1, 8), (1, 16),],
    pitch_list=[0, 0, 2, 2]
)
...
trinton.append_rests(
    score=score,
    voice="oboe voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1")]
)
...
trinton.append_rests(
    ...
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r8")]
)

trinton.append_rests(
    score=score,
    voice="bassoon voice",
    rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r16")]
)
...
for voice in ["bass clarinet voice", "bassoon voice"]:
    ...
    trinton.append_rests(
        score=score,
        voice=voice,
        rests=[abjad.Rest("r16"), abjad.Rest("r16")]
    )
...
for voice in ["horn voice", "trumpet voice", "tenor trombone voice",]:
    trinton.append_rests(
        score=score,
        voice=voice,
        rests=[abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"), abjad.Rest("r1"),]
...
for voice, index in zip(["horn voice", "trumpet voice", "tenor trombone voice", "tuba voice"], [0, 1, 2, 3,]):
...
trinton.attach_multiple(
    score=score,
    voice="percussion 2 voice",
    leaves=[0, 2, 4, 7, 10, 12, 15, 17, 19, 22, 25, 27, 30, 32, 34, 37, 40, 42, 45, 47, 49, 52, 55, 57, 60, 62, 64, 67, 70, 72, 75, 77,],
    attachments=[abjad.Dynamic("fff"), abjad.Articulation(">")]
)

trinton.attach(
    voice=score["percussion 2 voice"],
    leaves=[1, 3, 5, 8, 11, 13, 16, 18, 20, 23, 26, 28, 31, 33, 35, 38, 41, 43, 46, 48, 50, 53, 56, 58, 61, 63, 65, 68, 71, 73, 76,],
...
trinton.attach(
    ...
    leaves=[5, 13, 21, 29, 37, 45, 53, 61, 69, 77, 85, 93,],
...
trinton.attach_multiple(
    ...
    leaves=[2, 4, 7, 10, 13, 16, 19, 21, 24, 27, 31, 33, 36, 39, 41, 44, 48, 50, 53, 56, 58, 61, 65, 67, 71, 73, 75, 79, 82, 84, 88, 90, 92, 96, 99, 101],
    attachments=[abjad.Dynamic("fff"), abjad.Articulation(">"), abjad.Articulation("downbow")]
)

trinton.attach_multiple(
    score=score,
    voice="violin 2 voice",
    leaves=[3, 5, 8, 11, 15, 17, 20, 23, 25, 28, 32, 34, 37, 40, 42, 45, 49, 51, 55, 57, 59, 63, 66, 68, 72, 74, 76, 80, 83, 85, 89, 91, 93, 97, 100],
...
trinton.attach(
    ...
    leaves=[3, 7, 11, 15, 19, 23, 27, 31, 35, 39, 43, 47, ],
    attachment=abjad.Tie()
)
...
trinton.attach_multiple(
    score=score,
    voice="viola voice",
    leaves=[3, 6, 9, 13, 17, 19, 23, 26, 29, 33, 37, 39, 43, 46, 49,],
    attachments=[abjad.Articulation("upbow"), abjad.Dynamic("mp")]
)

trinton.attach(
    voice=score["viola voice"],
    leaves=[10, 14, 21, 30, 34, 41, 50,],
    attachment=abjad.Articulation("upbow")
)
...
trinton.attach_multiple(
    score=score,
    voice="cello voice",
    leaves=[2, 4, 6, 9, 12, 14, 17, 19, 21, 24, 27, 29, 32, 34, 36, 39, 42, 44, 47, 49, 51,],
    attachments=[abjad.Dynamic("fff"), abjad.Articulation(">"), abjad.Articulation("downbow")]
)
...
trinton.attach_multiple(
    score=score,
    voice="cello voice",
    leaves=[3, 5, 7, 10, 13, 15, 18, 20, 22, 25, 28, 30, 33, 35, 37, 40, 43, 45, 48, 50,],
    attachments=[abjad.Articulation("upbow"), abjad.Dynamic("mp")]
)

trinton.attach(
    voice=score["cello voice"],
    leaves=[8, 11, 16, 23, 26, 31, 38, 41, 46,],
    attachment=abjad.Articulation("upbow")
)
...
trinton.write_slur(
    ...
    start_slur=[6, 8, 12, 20, 23, 27, 30, 33, 35,],
    stop_slur=[7, 10, 18, 22, 26, 28, 32, 34, 37,],
)
...
trinton.attach(
    voice=score["flute voice"],
    leaves=[6, 8, 20, 27, 30, 33, 35,],
    attachment=abjad.StartHairpin("o<|")
)

trinton.attach(
    voice=score["flute voice"],
    leaves=[7, 10, 12, 18, 22, 23, 26, 28, 32, 34, 37,],
...
trinton.write_slur(
    ...
    start_slur=[7, 14, 20, 28,],
    stop_slur=[11, 17, 25, 34,]
)

trinton.attach(
    voice=score["oboe voice"],
    leaves=[7, 8, 9, 10, 14, 15, 16, 20, 21, 22, 23, 24, 28, 29, 30, 31, 32, 33,],
...
trinton.attach(
    voice=score["oboe voice"],
    leaves=[7, 9, 11, 15, 17, 21, 23, 25, 29, 31, 33,],
    attachment=abjad.Articulation("open")
)

trinton.attach(
    voice=score["oboe voice"],
    leaves=[8, 10, 14, 16, 20, 22, 24, 28, 30, 32, 34,],
    attachment=abjad.Articulation("stopped")
)

# bass clarinet attachments

for leaf, multiphonic in zip([5, 11, 14, 18, 22,], [5, 4, 3, 2, 1]):
...
for leaf, multiphonic in zip([6, 11, 15, 20, 24,], [5, 4, 3, 2, 1]):
...
trinton.attach_multiple(
    ...
    attachments=[
        abjad.Dynamic("f"),
        abjad.LilyPondLiteral(
            r'\boxed-markup "Fluttertongue, switch rapidly between 1st-7th" 1', format_slot="after"
        ),
    ]
)
...
for number in [16, 17, 18, 19, 21, 23, 24, 25, 26,]:
...
trinton.attach(
    voice=score["piano 2 voice"],
    leaves=[4, 7, 9, 12, 14, 16, 19, 21, 22, 24, 26, 27, 28, 30, 32, 33, 34, 36, 38, 39, 40,],
    attachment=abjad.Articulation(">")
)
...
trinton.unmeasured_stem_tremolo(
    abjad.select(score["harp voice"]).leaves(pitched=True)
)
...
trinton.write_slur(
    ...
    start_slur=[5, 16, 24, 32, 41,],
    stop_slur=[12, 20, 29, 38, 47,],
)
...
trinton.unmeasured_stem_tremolo(abjad.select(score["percussion 1 voice"]).leaves(pitched=True))
...
trinton.attach_multiple(
    ...
    attachments=[
        abjad.Dynamic("mp"),
        abjad.LilyPondLiteral(
            r'\boxed-markup "MST" 1', format_slot="after"
        ),
    ]
)
