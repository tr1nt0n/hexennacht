...
trinton.append_rests(
    score=score, voice="oboe voice", rests=[abjad.Rest("r1."), abjad.Rest("r8")]
)
...
trinton.append_rests(score=score, voice="oboe voice", rests=[abjad.Rest("r4")])
...
trinton.attach(voice=score["Global Context"], leaves=[0], attachment=hexennacht.tempo_3)

trinton.attach(voice=score["Global Context"], leaves=[4], attachment=hexennacht.tempo_4)

trinton.attach(voice=score["Global Context"], leaves=[8], attachment=hexennacht.tempo_5)

trinton.attach(voice=score["Global Context"], leaves=[9], attachment=hexennacht.tempo_4)

trinton.attach(
    voice=score["Global Context"], leaves=[11], attachment=hexennacht.tempo_5
)
...
trinton.attach(score["Global Context"], [10], start_text_span)
trinton.attach(score["Global Context"], [11], abjad.StopTextSpan())
...
trinton.attach(voice=score["flute voice"], leaves=[119], attachment=abjad.Fermata())
...
trinton.attach(voice=score["oboe voice"], leaves=[166], attachment=abjad.Fermata())
...
trinton.attach(voice=score["bassoon voice"], leaves=[20], attachment=abjad.Fermata())
...
trinton.attach_multiple(
    ...
    attachments=[
        ...
        abjad.LilyPondLiteral(
            r'\boxed-markup "Fluttertongue, rapidly switch between 1st and 7th" 1',
            format_slot="after",
        ),
        abjad.StartHairpin("<"),
    ],
...
trinton.attach(
    voice=score["tenor trombone voice"], leaves=[19], attachment=abjad.Fermata()
)
...
trinton.attach(voice=score["tuba voice"], leaves=[21], attachment=abjad.Dynamic("fff"))

trinton.attach(voice=score["tuba voice"], leaves=[21], attachment=abjad.Fermata())
...
trinton.attach(voice=score["marimba voice"], leaves=[18], attachment=abjad.Fermata())
...
trinton.attach(
    voice=score["percussion 2 voice"], leaves=[19], attachment=abjad.Fermata()
)
...
trinton.unmeasured_stem_tremolo(
    abjad.select(score["percussion 2 voice"]).leaves(pitched=True)
)
