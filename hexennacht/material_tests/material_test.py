...
hexennacht.drumming(
    score=score, voice="percussion 2 voice", durations=[(3, 8), (3, 4)], pitched=False
)
...
for voice in ["tuba voice", "contrabass voice"]:
    trinton.append_rests(
        score=score, voice=voice, rests=[abjad.Rest("r2."), abjad.Rest("r4")]
    )
    hexennacht.drone(
        score=score,
        voice=voice,
...
trinton.append_rests(score=score, voice="cello voice", rests=[abjad.Rest("r4")])
...
trinton.append_rests(score=score, voice="oboe voice", rests=[abjad.Rest("r8")])
...
trinton.append_rests(
    score=score, voice="oboe voice", rests=[abjad.Rest("r1"), abjad.Rest("r2")]
)
...
trinton.attach(
    voice=score["percussion 1 voice"], leaves=[0], attachment=abjad.Dynamic("mf")
)
...
hexennacht.gongs(score=score, voice="percussion 2 voice", leaves=[0])

trinton.attach(
    voice=score["percussion 2 voice"], leaves=[0], attachment=abjad.Dynamic("ff")
)
...
trinton.attach_multiple(
    ...
    leaves=[1],
    attachments=[
        abjad.LilyPondLiteral(r'\boxed-markup "w/ bow, CLB" 1', format_slot="after"),
        abjad.Dynamic("mp"),
        abjad.StartHairpin("<"),
    ],
)
...
for voice in [
    ...
    trinton.attach(voice=score[voice], leaves=[10], attachment=abjad.Dynamic("pp"))
